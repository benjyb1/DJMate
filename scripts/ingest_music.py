...
Drop in your entire mixing folder. This script will:
  ...
  6. Run auto_tagger.py on the newly added tracks
  7. Re-run 3d_coordinator.py to update UMAP 3-D positions for the frontend
